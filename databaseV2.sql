...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 10 Mars 2016 à 23:06
...
INSERT INTO `question` (`id`, `libelle`, `type`, `createdBy`) VALUES
(1, 'a quoi sert ngDblclick ?', 0, 4),
(2, 'a quoi sert ngCloak ?', 0, 4),
(3, 'Qu’est-ce qu’est Phalcon ?', 0, 3),
(4, 'Quelle est le langage de Phalcon ?', 0, 5);
...
INSERT INTO `questionnaire` (`id`, `libelle`, `idDomaine`, `date`, `createdBy`) VALUES
(3, 'angularJS', 4, '2015-03-12', 3),
...
ALTER TABLE `groupe_questionnaire`
  ADD PRIMARY KEY (`idGroupe`,`idQuestionnaire`),
...
ALTER TABLE `groupe_utilisateur`
  ...
  ADD KEY `fk_utilisateur_has_groupe_groupe1_idx` (`idGroupe`),
  ADD KEY `fk_utilisateur_has_groupe_utilisateur1_idx` (`idUtilisateur`);
...
ALTER TABLE `questionnaire`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_questionnaire_domaine1_idx` (`idDomaine`),
  ADD KEY `createdBy` (`createdBy`);
...
ALTER TABLE `realisation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_score_utilisateur1_idx` (`idUtilisateur`),
  ADD KEY `fk_score_questionnaire1_idx` (`idQuestionnaire`);
...
ALTER TABLE `reponse`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_idReponseQuestionx` (`idQuestion`);

--
-- Index pour la table `reponse_utilisateur`
--
ALTER TABLE `reponse_utilisateur`
  ADD PRIMARY KEY (`idReponse`,`idRealisation`),
  ADD KEY `fk_reponse_has_realisation_realisation1_idx` (`idRealisation`),
  ADD KEY `fk_reponse_has_realisation_reponse1_idx` (`idReponse`);
...
ALTER TABLE `utilisateur`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_utilisateur_rang1_idx` (`idRang`);
...
--
ALTER TABLE `question`
  ADD CONSTRAINT `question_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `utilisateur` (`id`);
...
ALTER TABLE `questionnaire`
  ...
  ADD CONSTRAINT `questionnaire_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `utilisateur` (`id`);
