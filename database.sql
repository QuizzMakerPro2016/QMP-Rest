...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 07 Mars 2016 à 19:41
...
INSERT INTO `groupe_questionnaire` (`groupe_id`, `questionnaire_id`) VALUES
(3, 3),
(3, 4);
...
INSERT INTO `question` (`id`, `libelle`, `questionnaire_id`, `open`) VALUES
...
`id` int(11) NOT NULL,
  ...
  `rang_id` int(11) NOT NULL DEFAULT '1'
...
ALTER TABLE `groupe_questionnaire`
 ADD PRIMARY KEY (`groupe_id`,`questionnaire_id`), ADD KEY `questionnaire_id` (`questionnaire_id`);
...
--
ALTER TABLE `groupe_questionnaire`
ADD CONSTRAINT `groupe_questionnaire_ibfk_1` FOREIGN KEY (`groupe_id`) REFERENCES `groupe` (`id`),
ADD CONSTRAINT `groupe_questionnaire_ibfk_2` FOREIGN KEY (`questionnaire_id`) REFERENCES `questionnaire` (`id`);
